const data = {
  backlog: [
    {
      ...
      color: "error",
      images: [
        `${process.env.baseUrl}images/unsplash/12.jpg`,
        `${process.env.baseUrl}images/unsplash/9.jpg`
      ]
    },
    {
  ...
  todo: [
    ...
    },
    {
      ...
      images: [`${process.env.baseUrl}images/unsplash/1.jpg`]
    },
    {
    ...
    },
    {
      ...
      images: [
        `${process.env.baseUrl}images/unsplash/5.jpg`,
  ...
  "In Process": [
    ...
    },
    {
      ...
      images: [
        `${process.env.baseUrl}images/unsplash/16.jpg`,
        `${process.env.baseUrl}images/unsplash/9.jpg`
      ]
    },
    {
  ...
  "Currently in progress": [
    ...
    },
    {
      ...
      images: [
        `${process.env.baseUrl}images/unsplash/10.jpg`,
        `${process.env.baseUrl}images/unsplash/11.jpg`
      ]
    },
    {
    ...
    },
    {
      ...
      images: [
        ...
        `${process.env.baseUrl}images/unsplash/14.jpg`
      ]
    }
  ],
  Complete: [
